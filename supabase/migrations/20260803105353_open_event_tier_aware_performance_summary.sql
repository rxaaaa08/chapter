-- Profit forecasting must use the same two-tier marketer fee that the accrual
-- ledger uses. This definition is based on the live production RPC dumped on
-- 2026-08-03; the founder-only gate and flat creator/manager fees are retained.
