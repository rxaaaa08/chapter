...
const demoTodos: Todo[] = [
  { id: 'todo-1', title: 'Test payment failure on the live website', done: false, created_at: '2026-07-11T08:00:00Z', completed_at: null },
  { id: 'todo-2', title: 'Check the new WhatsApp message', done: false, created_at: '2026-07-11T07:00:00Z', completed_at: null },
  { id: 'todo-3', title: 'Replace the event photograph', done: true, created_at: '2026-07-10T07:00:00Z', completed_at: '2026-07-11T06:00:00Z' },
];
...
export default function TodoCard({ demo = false }: { demo?: boolean }) {
  ...
  const addTodo = async () => {
    ...
    if (demo) {
      const todo: Todo = { id: `demo-${Date.now()}`, title: cleanTitle, done: false, created_at: new Date().toISOString(), completed_at: null };
