    ...
    <div className="flex flex-col px-6 py-10 gap-5 max-w-sm mx-auto w-full">
        ...
        {payment?.whatsapp_group_url && (
          <div className="bg-[#25D366]/8 border border-[#25D366]/20 rounded-3xl px-5 py-5 flex flex-col gap-3">
            <div>
              <p className="text-[13px] font-black text-gray-900 leading-tight">Join the trip group chat</p>
              <p className="text-[12px] text-gray-500 mt-0.5">Pickup details, last-minute updates and day-of coordination — all in one place.</p>
            </div>
            <a
              href={payment.whatsapp_group_url}
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center justify-center gap-2 w-full py-3.5 rounded-2xl bg-[#25D366] text-white text-[14px] font-bold active:opacity-80 transition-all"
            >
