                      ...
                      return (
                        <motion.div initial={{ opacity: 0, y: 6 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }} className="bg-white rounded-2xl border border-gray-200 p-3 mb-4">
                          ...
                          <a
                            ...
                            className={`mt-2 w-full bg-[#25D366] text-white rounded-xl py-2.5 text-[14px] font-semibold active:scale-[0.98] transition-all flex items-center justify-center gap-2 ${(!doubtText.trim() || submittingDoubt) ? 'opacity-40 pointer-events-none' : ''}`}
                          >
