...
const inviteEventMap: JourneyMapSeed = {
  ...
  nodes: [
    ...
    n('adv-wa', 420, 1000, 'whatsapp', 'Advance-paid WhatsApp',
      'advance_success_dpl — the amount plus the balance due date read from the chosen date’s timeline (step 3). Pay-at-venue events send the single-payment template instead, having no balance deadline to quote.'),
