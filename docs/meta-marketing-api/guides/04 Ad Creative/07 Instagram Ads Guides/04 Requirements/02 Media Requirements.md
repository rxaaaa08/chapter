<!-- Source: https://developers.facebook.com/documentation/ads-commerce/instagram/ads-api/reference/media-requirements | Saved: 2026-09-19 -->
...
**Note:** If you run [Advantage+ catalog ads](https://developers.facebook.com/docs/marketing-api/dynamic-product-ads), product images specified in [product feeds](https://developers.facebook.com/documentation/ads-commerce/catalog#setup-product-feed) must be at least 600px or more in both width and height.
...
**Note:** Videos cannot be cropped, but images can. The following information is only valid for images.
...
| Media | No cropping spec, and use_flexible_image_aspect_ratio set to false | No cropping spec, and use_flexible_image_aspect_ratio set to true, or not set<br><br>(Default behavior) | With 100x100 Cropping Spec |
| --- | --- | --- | --- |
