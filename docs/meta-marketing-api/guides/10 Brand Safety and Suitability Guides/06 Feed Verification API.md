<!-- Source: https://developers.facebook.com/documentation/ads-commerce/marketing-api/brand-safety-and-suitability/feed-verification | Saved: 2026-09-19 -->
...
### Ad Account API
Reference [Ad Account](https://developers.facebook.com/documentation/ads-commerce/marketing-api/reference/ad-account) for a complete list of ad account fields.
...
Reference [Ad Set](https://developers.facebook.com/documentation/ads-commerce/marketing-api/reference/ad-campaign) for a complete list of ad set fields and [Placement Targeting](https://developers.facebook.com/documentation/ads-commerce/marketing-api/audiences/reference/placement-targeting) for a complete list of targeting fields.
