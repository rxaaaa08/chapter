<!-- Source: https://developers.facebook.com/documentation/ads-commerce/marketing-api/reference/product-feed/flights | Saved: 2026-09-19 | Converted from the web page: Meta's "View as Markdown" export returns an error for this page -->

# Product Feed Flights
...
Returns flights in the product feed
...
```
GET /v25.0/{product-feed-id}/flights HTTP/1.1
Host: graph.facebook.com

```

 Try it in [Graph API Explorer](https://developers.facebook.com/tools/explorer/?method=GET&path=%7Bproduct-feed-id%7D%2Fflights&version=v25.0)
...
| Field | Description |
| --- | --- |
| `total_count`<br>*unsigned int32* | Total number of flights in the product feed |
