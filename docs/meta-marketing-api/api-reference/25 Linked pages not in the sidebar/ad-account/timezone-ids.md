<!-- Source: https://developers.facebook.com/docs/marketing-api/reference/ad-account/timezone-ids | Saved: 2026-09-19 | From Meta's older docs site (this page has not moved to the new site yet), converted from the web page -->
